...
namespace Seulitools
{
    public class DiscordRPCAPI
    {
        ...
        public static void Initialize(string applicationId, ref EventHandlers handlers, bool autoRegister, string optionalSteamId)
        {
            ...
            staticEventHandlers.readyCallback += DiscordRPCAPI.ReadyCallback;
            staticEventHandlers.disconnectedCallback += DiscordRPCAPI.DisconnectedCallback;
            staticEventHandlers.errorCallback += DiscordRPCAPI.ErrorCallback;
            staticEventHandlers.joinCallback += DiscordRPCAPI.JoinCallback;
            staticEventHandlers.spectateCallback += DiscordRPCAPI.SpectateCallback;
            staticEventHandlers.requestCallback += DiscordRPCAPI.RequestCallback;
